    ...
    public void explode()
    {
        ...
        else
        {
            foreach (GameObject frag in fragments)
            {
                ...
                frag.SetActive(true);
                Destroy(frag.GetComponent<Rigidbody2D>(), 1);
            }
        }
    ...
    public void generateFragments()
    {
        ...
        foreach (GameObject p in fragments)
        {
            if (p != null)
            {
                ...
                WindObject windObject = p.AddComponent<WindObject>();
                windObject.windType = WindType.Translate;
                windObject.weight = Random.Range(.97f, .99f);
            }
        }
